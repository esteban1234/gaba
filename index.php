...
<div class="section seccion1">
  ...
  <div class="banner2">
    <div class="fondo">
      <p>Te ofrecemos nuestro Servicio a Domicilio el cual nos permite llegar al lugar que <br> elijas en la República Mexicana
      </p>
      <div class="botonc" >
        <a class="btn btn-danger btn-outline btn-lg " style="color: #fff; border: 1px #fff solid;" href="vistas/contacto.php">CONTACTANOS</a>
      </div>
    </div>
  </div>
